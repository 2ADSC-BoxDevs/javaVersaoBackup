            ...
            new Timer().scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() {
                    ...
                    if (memoria.getEmUso() > 3.) {
                        ...
                        slack.sendMessageToSlack("Alerta! O uso da memoria esta muito alto, seu computador irá travar");

                    }
                    if (processador.getFrequencia() > 4) {
                        System.out.println("Processador muito usado");
                        slack.sendMessageToSlack("Alerta! O uso da processador esta muito alto, seu computador irá travar");

                    }
                    if (memoria.getDisponivel() > 2.5) {
                        System.out.println("Quase zero de memoria");
                        slack.sendMessageToSlack("Alerta! Resta pouca memoria, seu computador irá travar");
                    }
                }
            }, 0, 10000);
